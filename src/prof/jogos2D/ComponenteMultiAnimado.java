...
//				g.drawImage(frames[k][i], getPosicao().x+i*getComprimento(), getPosicao().y+k*getAltura(), null);
	...
	/**
	 * indica quantas frames tem esta animação
	 * @return o número de frames que esta animação tem
	 */
	...
	/**
	 * indica se a animação se deve repetir ou se se faz apenas uma vez
	 * @param repeat true se é +ara repetir
	 */
	...
	/**
	 * Indica se a animação é repetitiva ou apenas funcioanr uma vez
	 * @return true se a animação se repte sempre
	 */
	...
	/**
	 * Indica se a animação já acabou
	 * @return true se já acabou
	 */
