 ...
 */
public interface ComponenteVisual extends Cloneable {
	...
	/**
	 * indica se um dado ponto est´+a dentro da imagem
	 * @param pt ponto a verificar
	 * @return true se esse ponto estiver dentro da imagem
	 */
	public boolean contemPonto( Point pt );
	
	/**
	 * desloca o desenho em x e em y
	...
	/**
	 * devolve uma cópia do componente
	 * @return uma cópia simples do componente
	 */
